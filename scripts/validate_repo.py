...
EXPECTED_EVALS = {
    ...
    "12-search-capability-routing.md",
...
def validate_vnext_contracts() -> None:
    required_phrases = {
        ...
        REPO_ROOT / "AGENTS.md": (
            ...
            "Agent Reach / AnySearch capability routing",
        ),
        ...
        REPO_ROOT / "docs" / "integrations" / "agent-reach.md": (
